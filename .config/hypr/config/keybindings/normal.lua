...
hl.bind("SUPER + ALT + T", hl.dsp.exec_cmd(music), { description = "Open music TUI player" })
...
hl.bind(mainMod .. " + Tab", Toggle_layout_for_workspace, { description = "Toggle layout for workspace" })
